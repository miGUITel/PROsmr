...
| 8      | [Tarea 6: El programa que toma decisiones](Tarea6.md)  | RA3 | a             | Programas con condicionales (if/else, switch).                          | **Scratch** (ramificaciones de bloques), **JDoodle** (if/else en Java), **CodingBat** (ejercicios de condicionales)             |
| 9      | [Tarea 7: Bucles y más bucles](Tarea7.md)              | RA3 | b             | Resolver ejercicios con bucles (for, while).                            | **Blockly** (repeticiones), **Scratch** (bucles visuales), **JDoodle** (for/while), **CodingBat** (ejercicios de bucles)        |
| 7      | [Tarea 8: Uso de librerías y comentarios](Tarea8.md)   | RA2 | e, f          | Incorporar librerías estándar y documentar el código.                   | **JDoodle** (uso de `Math` en Java, comentarios), **IntelliJ IDEA** (mejor documentación del código)                            |
